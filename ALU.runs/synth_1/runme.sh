...
HD_PWD='D:/Faculta/IIIsem1/SCS/Lab/Lab4/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WTree.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WTree.tcl
