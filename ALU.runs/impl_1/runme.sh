...
HD_PWD='D:/Faculta/IIIsem1/SCS/Lab/Lab4/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WTree.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WTree.tcl -notrace
